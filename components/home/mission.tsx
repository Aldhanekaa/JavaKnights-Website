...
export default function MissionSection() {
  return (
    <div className="w-full mt-40 relative mb-40">
      <div
        className="w-full absolute bottom-0 h-2/6"
        style={{
          background: "#2C2C2C",
      ...
      <div className="container mx-auto">
        ...
        <div className="relative">
          ...
          />
          <p className="text-5xl text-gray-400 text-center align-center mt-10 leading-normal">
        ...
        <div className="w-full grid grid-cols-11">
          ...
          {/* <div
            id="missionImage"
            className="col-span-9 bg-contain bg-center bg-no-repeat"
            style={{
              height: "670px",
              maxHeight: "670px",
              background: "url(/img/missionImage.png)",
            }}
          ></div> */}
          <div
            id="missionImage"
            className="col-span-9 overflow-hidden relative mt-20"
            style={{
              height: "670px",
              maxHeight: "670px",
            }}
